    ...
    <form class="max-w-sm mx-auto" method="POST" action="{{ route('login') }}" novalidate>
        ...
        <div class="mb-7 flex items-center justify-center">
            <a href="{{ route('loginForm') }}" class="flex items-center justify-center">
              <img src="https://i.ibb.co/q0SVKMQ/bibliotech-logo1.png" alt="Logo de Bibliotech">
            </a>
        </div>
        ...
        <div class="mb-5">
            ...
            <input type="password" id="password" name="password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-none focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
            <!-- Error de contraseña -->
            @error('password')
                <p class="bg-red-500 text-white my-2 rounded-lg text-lg text-center p-2">{{ $message }}</p>
            @enderror
